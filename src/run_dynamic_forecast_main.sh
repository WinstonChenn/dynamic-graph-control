...
do
    ...
    python dynamic_forecast_main.py  --seed $seed \
        ...
        --model_name SAGELSTM --batch 32 --epochs 1000 --lr 1e-3 \
        --l2 5e-4 --patience 100 --delta 1e-4 \
        --eval_init_inf_prop 0.1 --eval_inf_thresh 0.3 --eval_max_inf_days 11 \
        --eval_inf_param 1.0 1.0 --eval_sus_param 1.0 1.0 --eval_rec_param 1.0 1.0 \
        --eval_int_param 1.0 1.0 --num_eval_times 10 --num_forecast_times 50 --overwrite
    ...
    python dynamic_forecast_main.py  --seed $seed \
        ...
        --model_name SAGELSTM --batch 32 --epochs 1000 --lr 1e-3 \
        --l2 5e-4 --patience 100 --delta 1e-4 \
        --eval_init_inf_prop 0.1 --eval_inf_thresh 0.3 --eval_max_inf_days 15 \
        --eval_inf_param 1.0 1.0 --eval_sus_param 1.0 1.0 --eval_rec_param 1.0 1.0 \
        --eval_int_param 1.0 1.0 --num_eval_times 10 --num_forecast_times 50 --overwrite
    ...
    python dynamic_forecast_main.py  --seed $seed \
        ...
        --model_name SAGELSTM --batch 32 --epochs 1000 --lr 1e-3 \
        --l2 5e-4 --patience 100 --delta 1e-4 \
        --eval_init_inf_prop 0.1 --eval_inf_thresh 0.25 --eval_max_inf_days 10 \
        --eval_inf_param 1.0 1.0 --eval_sus_param 1.0 1.0 --eval_rec_param 1.0 1.0 \
        --eval_int_param 1.0 1.0 --num_eval_times 10 --num_forecast_times 50 --overwrite
    ...
    python dynamic_forecast_main.py  --seed $seed \
        ...
        --model_name SAGELSTM --batch 32 --epochs 1000 --lr 1e-3 \
        --l2 5e-4 --patience 100 --delta 1e-4 \
        --eval_init_inf_prop 0.1 --eval_inf_thresh 0.2 --eval_max_inf_days 10 \
        --eval_inf_param 1.0 1.0 --eval_sus_param 1.0 1.0 --eval_rec_param 1.0 1.0 \
        --eval_int_param 1.0 1.0 --num_eval_times 10 --num_forecast_times 50 --overwrite
    ...
    python dynamic_forecast_main.py  --seed $seed \
        ...
        --model_name SAGELSTM --batch 32 --epochs 1000 --lr 1e-3 \
        --l2 5e-4 --patience 100 --delta 1e-4 \
        --eval_init_inf_prop 0.1 --eval_inf_thresh 0.15 --eval_max_inf_days 10 \
        --eval_inf_param 1.0 1.0 --eval_sus_param 1.0 1.0 --eval_rec_param 1.0 1.0 \
        --eval_int_param 1.0 1.0 --num_eval_times 10 --num_forecast_times 50 --overwrite
done
